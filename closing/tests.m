...
% Dynamique en boucle fermée (Principe de superposition)
...
%         
%         for k = 1:NPT
%             [x,y,vx,vy] = analytical_inverted(0,hold_points(i,2),vx0,0,0,0,w,dt*(k-1));
%             trajX(:,k) = [-x,y,-vx,vy];
%         end
%     else
