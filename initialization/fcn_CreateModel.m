function [A,B]=fcn_CreateModel(Xi,eulerDCDT_i)
% Function that creates Pirat's model
% X0 = (x0, y0, z0) being negative the approach axe coordenate.

load("FullMatrices.mat");
...
sxDT_i = Xi(1); syDT_i = Xi(2); szDT_i = Xi(3); % Initial chaser position wrt target (in target docking frame)
